...
//        return view;
        ...
        if(viewModel.mensagem.getProgramadoPara() == null){
    ...
    public void onClickTrocar(View v){
        ...
        formCalendario.setDataAnterior(viewModel.mensagem.getProgramadoPara().toCalendar(null));
    ...
    public void onSwitchProgramadoChange(CompoundButton btn, boolean ativo){
        ...
        if(flagInicioEdicao && mensagem.getProgramadoPara() != null){
    ...
    public void setData(Calendar umaData) {
        viewModel.mensagem.setProgramadoPara(new DateTime(umaData,
    ...
    private void ocultaDataEscolhida(){
        ...
        btnTrocar.setVisibility(View.GONE);
        viewModel.mensagem.setProgramadoPara(null);
    }

    private void exibeDataEscolhida(){

        textViewProgramado.setText(DateTimeFormat
                .forPattern("dd/MM/yy HH:mm").print(viewModel.mensagem.getProgramadoPara()));
    ...
    Observer<Integer> retornoObserver = new Observer<Integer>() {
        ...
        public void onChanged(Integer retorno) {
            ...
            if(retorno == 1){
                Toast.makeText(getContext().getApplicationContext(), "Mensagem cadastrada!", Toast.LENGTH_SHORT).show();
