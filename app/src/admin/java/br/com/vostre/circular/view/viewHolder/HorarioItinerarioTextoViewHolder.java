...
public class HorarioItinerarioTextoViewHolder extends RecyclerView.ViewHolder {
    ...
    public HorarioItinerarioTextoViewHolder(LinhaHorariosItinerariosBinding binding, AppCompatActivity context,
