...
import br.com.vostre.circular.view.RegistraViagemActivity;
...
public class LocationUpdatesService extends Service {
    ...
    public boolean onUnbind(Intent intent) {
        ...
        if (!mChangingConfiguration && LocationUpdateUtils.getRequestingLocationUpdates(this)) {
    ...
    private Notification getNotification() {
        ...
        PendingIntent activityPendingIntent = PendingIntent.getActivity(this, 0,
                new Intent(this, RegistraViagemActivity.class), 0);
    ...
    private void onNewLocation(Location location) {
        ...
        if(ativo){
            Log.i(TAG+" RT", location.getLatitude()
                    +" | "+location.getLongitude());

            locationResultHelper.updateRoute(this, location);
        }
    ...
    private void createLocationRequest() {
        ...
        mLocationRequest.setMaxWaitTime(6000);
