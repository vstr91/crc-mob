package br.com.vostre.circleview;
...
public class CircleView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            corArcoMaior = typedArray.getColor(R.styleable.CircleView_corArcoMaior,
                    corArcoMaior);
            corArcoMenor = typedArray.getColor(R.styleable.CircleView_corArcoMenor,
                    corArcoMenor);
            espessuraArcoMaior = typedArray.getInteger(R.styleable.CircleView_espessuraArcoMaior,
                    espessuraArcoMaior);
            espessuraArcoMenor = typedArray.getInteger(R.styleable.CircleView_espessuraArcoMenor,
                    espessuraArcoMenor);
            imagem = typedArray.getDrawable(R.styleable.CircleView_imagem);
            typedArray.recycle();
